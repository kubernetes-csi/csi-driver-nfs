# Install NFS CSI driver v4.13.0 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-nfs/v4.13.0/deploy/install-driver.sh | bash -s v4.13.0 --
```
...
cd csi-driver-nfs
./deploy/install-driver.sh v4.13.0 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-nfs/v4.13.0/deploy/uninstall-driver.sh | bash -s v4.13.0 --
```
...
./deploy/uninstall-driver.sh v4.13.0 local
```
