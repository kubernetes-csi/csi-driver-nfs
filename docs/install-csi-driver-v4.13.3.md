# Install NFS CSI driver v4.13.3 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-nfs/v4.13.3/deploy/install-driver.sh | bash -s v4.13.3 --
```
...
cd csi-driver-nfs
./deploy/install-driver.sh v4.13.3 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-nfs/v4.13.3/deploy/uninstall-driver.sh | bash -s v4.13.3 --
```
...
./deploy/uninstall-driver.sh v4.13.3 local
```
