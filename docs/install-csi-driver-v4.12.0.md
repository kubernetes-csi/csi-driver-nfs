# Install NFS CSI driver v4.12.0 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-nfs/v4.12.0/deploy/uninstall-driver.sh | bash -s v4.12.0 --
```
